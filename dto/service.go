...
type ServiceListInput struct {
	...
	PageNo int `json:"page_no" form:"page_no" comment:"页数" example:"1" validate:""`
...
func (t *ServiceDeleteInput) BindValidParam(c *gin.Context) error {
...
func (t *ServiceAddHTTPInput) BindValidParam(c *gin.Context) error {
	return public.DefaultGetValidParams(c, t)
}