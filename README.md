...
项目地址：https://github.com/lhc328/go_gateway_demo
### 现在开始
- 安装软件依赖
go mod使用请查阅：
...
[GIN-debug] GET    /demo/index               --> github.com/lhc328/go_gateway_demo/controller.(*Demo).Index-fm (6 handlers)
[GIN-debug] GET    /demo/bind                --> github.com/lhc328/go_gateway_demo/controller.(*Demo).Bind-fm (6 handlers)
[GIN-debug] GET    /demo/dao                 --> github.com/lhc328/go_gateway_demo/controller.(*Demo).Dao-fm (6 handlers)
[GIN-debug] GET    /demo/redis               --> github.com/lhc328/go_gateway_demo/controller.(*Demo).Redis-fm (6 handlers)
